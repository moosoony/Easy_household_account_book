...
public class ExpenRequest extends StringRequest {
    // 서버 URL 설정 ( PHP 파일 연동 )
    final static private String URL = "http://moomoo.dothome.co.kr/Expen.php";
    private Map<String, String> map;

    public ExpenRequest(String Expen_Date, String Expen_Category, String Expen_Sum, String Expen_UserID, Response.Listener<String> listener) {
