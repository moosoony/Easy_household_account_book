...
import com.es.household_account_book.IncomeWrite;
...
public class date extends AppCompatActivity {
    ...
    String date = "";
    String result;
    String incomedate_db;
    public static Context context_incomedate; // context 변수 선언

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.date);
        context_incomedate = this;
...
//stt코드 끝
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(date.this, IncomeWrite.class); //지금 액티비티에서 다른 액티비티로 이동하는 인텐트 설정
