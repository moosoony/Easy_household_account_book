...
public class account extends AppCompatActivity {
    ...
    public static Context context_incomeaccount; // context 변수 선언
    String date;
    String category;
    String account;
    String incomeaccount_db;
    ...
    private RecognitionListener listener = new RecognitionListener() {
        ...
        public void onResults(Bundle results) {
            ...
            if( result.matches("^[0-9]*$")) { //숫자만 입력되었을 경우
                ...
                incomeaccount_db = result;
                //인텐트 선언 및 정의
                Intent intent_voice = new Intent(com.es.household_account_book.income_element.account.this, income_voice_main.class);
