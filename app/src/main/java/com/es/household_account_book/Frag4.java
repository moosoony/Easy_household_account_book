...
public class Frag4 extends Fragment {
    ...
    public static Context context_Search; // context 변수 선언
    @Override
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.activity_search_start, container, false);
        ct = container.getContext();
        context_Search = ct;

        textView = view.findViewById(R.id.sttResult);
        sttBtn = (ImageButton) view.findViewById(R.id.btn_sestt);
    ...
    private RecognitionListener listener = new RecognitionListener() {
        ...
        public void onResults(Bundle results) {
            ...
            if(result.equals("기타")||result.equals("용돈") || result.equals("월급") || result.equals("식비") || result.equals("쇼핑") || result.equals("의료") || result.equals("교통")){
                onstart(result);
                Search_Data = result;

                Intent intent = new Intent(getActivity(), SearchStore.class);
                intent.putExtra("Search_Data",Search_Data.toString()); //데이터 넣기
