...
public class Stt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecognizer= createSpeechRecognizer(Stt.this); // 새 SpeechRecognizer 를 만드는 팩토리 메서드
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Stt.this, MainActivity.class); //지금 액티비티에서 다른 액티비티로 이동하는 인텐트 설정
        ...
        public void onResults(Bundle results) {
            ...
            if(result.equals("캘린더")){
                ...
                new Handler().postDelayed(new Runnable()
                {
                    ...
                    public void run()
                    {
                        Intent intent = new Intent(Stt.this, Calendar.class);
            ...
            else if (result.equals("로그인") || result.equals("로그아웃")){
                onstart(result);
                ...
                new Handler().postDelayed(new Runnable()
                {
                    ...
                    public void run()
                    {
                        Intent intent = new Intent(Stt.this,LoginActivity.class);
                        startActivity(intent);
                        finish();
                    }
                }, 600);// 0.6초 정도 딜레이를 준 후 시작
                ...
                new Handler().postDelayed(new Runnable()
                {
                    ...
                    public void run()
                    {
                        Intent intent = new Intent(Stt.this,RegisterActivity.class);
                        startActivity(intent);
                        finish();
                    }
                }, 600);// 0.6초 정도 딜레이를 준 후 시작
                ...
                new Handler().postDelayed(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                            intent = new Intent(Stt.this, Analysis.class);
                        }
                        startActivity(intent);
                        finish();
                    }
                ...
                new Handler().postDelayed(new Runnable()
                {
                    ...
                    public void run()
                    {
                        Intent intent = new Intent(Stt.this, SearchStart.class);
                        startActivity(intent);
                        finish();
                    }
                }, 600);// 0.6초 정도 딜레이를 준 후 시작
                ...
                new Handler().postDelayed(new Runnable()
                {
                    ...
                    public void run()
                    {
                        Intent intent = new Intent(Stt.this, Expenses.class);
                        startActivity(intent);
                        finish();
                    }
                }, 600);// 0.6초 정도 딜레이를 준 후 시작
                ...
                new Handler().postDelayed(new Runnable()
                {
                    ...
                    public void run()
                    {
                        Intent intent = new Intent(Stt.this, IncomeWrite.class);
                        startActivity(intent);
                        finish();
                    }
                }, 600);// 0.6초 정도 딜레이를 준 후 시작
