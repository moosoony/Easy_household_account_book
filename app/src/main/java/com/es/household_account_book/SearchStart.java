...
public class SearchStart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sttBtn = (ImageButton) findViewById(R.id.btn_sestt);
        ...
        mRecognizer= createSpeechRecognizer(SearchStart.this); // 새 SpeechRecognizer 를 만드는 팩토리 메서드
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(SearchStart.this, MainMenu.class); //지금 액티비티에서 다른 액티비티로 이동하는 인텐트 설정
        ...
        public void onResults(Bundle results) {
            ...
            if(result.equals("기타") || result.equals("용돈") || result.equals("월급") || result.equals("식비") || result.equals("쇼핑") || result.equals("의료") || result.equals("교통")){
                ...
                new Handler().postDelayed(new Runnable()
                {
                    ...
                    public void run()
                    {
                        Intent intent = new Intent(SearchStart.this, SearchResult.class);
