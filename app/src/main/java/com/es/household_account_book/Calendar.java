...
public class Calendar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContext = this; // 다른 액티비티에서 함수 호출하기 위해 선언
...
//stt코드 시작
        ...
        mRecognizer= createSpeechRecognizer(Calendar.this);
...
//stt코드 끝
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Calendar.this, MainMenu.class); //지금 액티비티에서 다른 액티비티로 이동하는 인텐트 설정
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (success) { // 데이터 가져오기 성공
                        ...
                        Toast.makeText(getApplicationContext(),"지출 연결에 실패하였습니다.",Toast.LENGTH_SHORT).show();
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (success) { // 데이터 가져오기 성공
                        ...
                        Toast.makeText(getApplicationContext(),"수입 연결에 실패하였습니다.",Toast.LENGTH_SHORT).show();
