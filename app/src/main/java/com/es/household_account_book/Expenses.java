...
public class Expenses extends AppCompatActivity {
    ...
    private Button btn_ocr, btn_write;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_ocr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Expenses.this, ExpensesOcr.class);
        ...
        btn_write.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Expenses.this, ExpensesWrite.class);
                startActivity(intent);
            }
        });
        ...
        mRecognizer= createSpeechRecognizer(Expenses.this); // 새 SpeechRecognizer 를 만드는 팩토리 메서드
        ...
        btn_istt.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                onstart("촬영을 시작하시려면 예 작성하시려면 아니오를 말씀해주세요");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Expenses.this, MainMenu.class); //지금 액티비티에서 다른 액티비티로 이동하는 인텐트 설정
